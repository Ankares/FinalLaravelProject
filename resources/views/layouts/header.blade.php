    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav offset-0 col-12 col-lg-auto offset-lg-1 me-lg-auto mb-2 justify-content-center mb-md-0">
          <li class="lead">
            <a href="/" class="nav-link px-2 text-white">Shop</a>
          </li>
          <li class="lead">
            <a href="/shopping-cart" class="nav-link px-2 text-white">Cart</a>
          </li>
        </ul>
        <div class="text-end">
          @if (Route::has('login'))
            ...
            @else
              <button type="button" class="btn btn-outline-light me-3"><a href="{{ route('login') }}">Log in</a></button>
            @if (Route::has('register'))
              <button type="button" class="btn btn-outline-light"><a href="{{ route('register') }}">Sign-up</a></button>
            @endif
            @endauth
          @endif
        </div>
